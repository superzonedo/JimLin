      ...
      >
        ...
        <View style={styles.statsRow}>
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>本月總出現次數</Text>
          </View>
...
function calculateStats(ingredients: HighRiskIngredient[]): Stats {
  ...
  ingredients.forEach((ingredient) => {
    ...
    // 根據風險等級計算風險分數
    const riskScore = ingredient.riskScore || getRiskScoreFromLevel(ingredient.riskLevel);
...
function getRiskScoreFromLevel(riskLevel: string): number {
  switch (riskLevel) {
    case "high":
      return 75;
    case "medium":
